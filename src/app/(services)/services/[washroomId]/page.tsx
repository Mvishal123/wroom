...
const Page = ({ params }: { params: { washroomId: string } }) => {
  ...
  return (
    <>
      {loading && (
        <div className="page-min-height w-screen flex justify-center items-center">
          <FaSpinner className="animate-spin" />
        </div>
      )}
      {!loading && !washroomData && (
        <div className="page-min-height w-screen flex justify-center items-center">
          ...
          <section className="mt-12">
            ...
            <div className="mt-12">
              ...
              <div className="mt-4 px-4">
                <CarouselContainer
                  settings={{ infinite: true, slidesToScroll: 1 }}
                >
